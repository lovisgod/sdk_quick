...
enum class ICCData(val tagName: String, val tag: Int) {
    ...
    TERMINAL_VERIFICATION_RESULT("Terminal Verification Result", 0x95),
    ...
    APPLICATION_INTERCHANGE_PROFILE("App Interchange Profile", 0x82),
    ...
    DEDICATED_FILE_NAME("Dedicated File Name", 0x84),
    ...
    // Issuer response
    ISSUER_AUTHENTICATION("Issuer Authentication", 0x91),
    ISSUER_SCRIPT1("Issuer script 1", 0x71),
    ISSUER_SCRIPT2("Issuer script 1", 0x72)
